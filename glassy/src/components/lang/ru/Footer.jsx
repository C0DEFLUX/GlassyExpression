        ...
        <footer id="contact" className="min-h-[20rem] border-t-[2px] border-gray-200 relative flex flex-col items-center justify-center">
            ...
            <div className="footer-wrapper gap-8 mt-20 flex flex-col justify-between items-center container lg:flex-row lg:gap-0">
                ...
                <div className="footer-nav mb-4 flex flex-col items-center gap-4 w-[20rem] lg:items-end lg:mb-0">
                    <a className="underline" href="/">Начало</a>
                    <a className="underline" href="#about">О нас</a>
                    <a className="underline" href="#work">Pабота</a>
                    <a className="underline" href="#contact">Контакт</a>
                </div>

            </div>
            <div  onClick={() => {window.scrollTo({top: 0, behavior: 'smooth'});}} className="mb-4 flex gap-2 items-center font-bold">
                <p>НАВЕРНУТЬСЯ НАВЕРХ</p>
                <img className="h-[26px]" src={ChevUp} alt="Chevron up"/>
            </div>
